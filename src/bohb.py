...
def cnn_from_cfg(cfg, seed, instance, budget, **kwargs):
    """
    ...
    data = ImageFolder(cfg['data_dir'], transform=data_augmentations)
...
scenario = Scenario({"run_obj": "quality",  # we optimize quality (alternative to runtime)
                     "wallclock-limit": 5400,  # max duration to run the optimization (in seconds)
